    ...
    <>
      {solo ? (
        <div className={styles.big_card}>
          <img src={data.imageUrl} className={styles.big_card_image} />
          <div className={styles.big_card_text_container}>
            <h2 className={styles.big_card_name}>{data.itemName}</h2>
                ...
                return (
                  <div key={index} className={styles.cards_container}>
                    <div className={item.selected ? styles.price_card_selected : styles.price_card} onClick={() => onSelect(item)}>
                      <h2 className={styles.card_name}>{item.itemName}</h2>
                ...
                return (
                  <div key={index} className={styles.cards_container}>
                    <div className={size === 'big' ? styles.big_card : styles.card} onClick={() => onSelect(item)}>
                      <img src={item.imageUrl} className={size === 'big' ? styles.big_image : styles.image} />
                      <h2 className={size === 'big' ? styles.big_card_name : styles.card_name}>{item.itemName}</h2>
